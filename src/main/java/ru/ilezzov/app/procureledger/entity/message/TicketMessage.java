...
import ru.ilezzov.app.procureledger.entity.ticket.Ticket;
import ru.ilezzov.app.procureledger.entity.ticket.TicketStatus;
...
@Getter
@Setter
public class TicketMessage extends AbstractEntity<Long> {
